...
import 'package:somics_os/widget/lazy_list/lazy_list_controller.dart';
import 'package:somics_os/widget/lazy_list/list_vertical_item.dart';
          ...
          child: loading || items.isNotEmpty
              ? widget.lineItemCount > 1
                    ? ListVerticalItem<T>(
                        ...
                        viewPadding:
                            widget.listPadding ?? padding(vertical: 12),
