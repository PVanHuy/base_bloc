import 'package:somics_os/core/app_gradient.dart';
...
void showConfirmDialog({
  ...
  final confirmGradient =
      gradientBtn ?? (colorBtn == null ? AppGradient.redGradient : null);
  final confirmColor = confirmGradient != null
      ? null
      : colorBtn ?? appTheme.appColor;
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: CustomButton(
                    buttonText: cancelBtnTitle.isNotEmpty
                        ? cancelBtnTitle
                        : 'cancel'.tr,
                    color: appTheme.sliverColor,
                    textColor: textColorBtnBorder ?? appTheme.blackColor,
                    onPressed: Get.back,
                  ),
                ),
