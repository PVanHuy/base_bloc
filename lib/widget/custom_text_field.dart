...
import 'package:somics_os/widget/line_widget.dart';
                ...
                child: Row(
                  children: [
                    if (widget.titleIcon.isNotEmpty) ...[
                      ImageAssetCustom(imagePath: widget.titleIcon, size: 24.w),
                      SizedBox(width: 8.w),
                    ],
                    Text(
                      widget.titleText,
                      style:
                          widget.titleStyle ?? StyleThemeData.size14Weight700(),
                    ),
                    ...
                    builder: (context, validateValue, child) {
                      return ValueListenableBuilder<bool>(
                        ...
                        builder: (context, statusSalue, child) {
                          ...
                          final showRegularBorder =
                              widget.showBorder &&
                              (!widget.isGradientBorder || hasError);
                            ...
                            decoration: InputDecoration(
                              ...
                              enabledBorder: OutlineInputBorder(
                                ...
                                borderSide: BorderSide(
                                  style: showRegularBorder ? .solid : .none,
                                  width: 1.w,
                                  color:
                                      (widget.errorText.isNotEmpty ||
                                          validateValue.isNotEmpty)
                              ...
                              errorBorder: OutlineInputBorder(
                                ...
                                borderSide: BorderSide(
                                  ...
                                  width: 1.w,
                                  color:
                                      widget.colorBorder ?? appTheme.errorColor,
                                ),
                              ),
                              ...
                              labelStyle: StyleThemeData.size12Weight400(
                                color: appTheme.blueBellColor,
                              ),
                              fillColor:
                                  widget.fillColor ?? appTheme.whiteColor,
                              hintStyle:
                                  widget.hintStyle ??
                                  StyleThemeData.size14Weight400(
                                    color:
                                        widget.colorStyle ??
                                        appTheme.gray8FColor,
                                  ),
                              filled: true,
                          ...
                          if (!widget.isGradientBorder) return textField;
                          ...
                          return Container(
                            padding: padding(
                              all: hasError ? 0 : widget.gradientBorderWidth,
                            ),
                            decoration: BoxDecoration(
                              gradient: hasError ? null : gradientBorder,
            ...
            builder: (context, statusSalue, child) {
              return ValueListenableBuilder<String>(
                ...
                builder: (context, validateMessage, child) {
                  return LineWidget(
                    color:
                        (widget.errorText.isEmpty && validateMessage.isNotEmpty)
                        ? appTheme.red55Color
                        : widget.errorText.isNotEmpty
                        ? appTheme.red55Color
                        : (widget.errorText.isEmpty &&
