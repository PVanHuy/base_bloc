...
class AppGradient {
  static LinearGradient blueBFFAndAFFGradient = const LinearGradient(
    colors: [Color(0xFF006BFF), Color(0xFF00AAFF)],
  );

  static LinearGradient gradientBlueGenderMale = LinearGradient(
    colors: [appTheme.blueBFFColor, appTheme.blueFFColor],
  );

  static LinearGradient gradientPinkFemale = LinearGradient(
    colors: [appTheme.pinkA6Color, appTheme.pink8CColor],
  );
  ...
  static LinearGradient redGradient = LinearGradient(
    colors: [appTheme.red61Color, appTheme.appColor],
  );
