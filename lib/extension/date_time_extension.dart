import 'package:somics_os/constant/date_format_constants.dart';
...
extension DateFormatter on String? {
  ...
  String get toHHmmddMMyyyyDot {
    ...
    try {
      final dateTime = DateTime.parse(this!).toLocal();
      final formattedDate = DateFormat(
        DateConstants.hhMMddMMMMyyyyDot,
      ).format(dateTime);
      return formattedDate;
    } catch (e) {
      return 'invalid_format'.tr;
  ...
  String get tohhmmSpaceddMMyyyy {
    ...
    try {
      final dateTime = DateTime.parse(this!).toLocal();
      final formattedDate = DateFormat(
        DateConstants.hhmmSpaceddMMyyyy,
      ).format(dateTime);
      return formattedDate;
    } catch (e) {
      return 'invalid_format'.tr;
