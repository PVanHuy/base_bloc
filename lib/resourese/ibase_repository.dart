...
import 'package:somics_os/resourese/service/localization_service.dart';
import 'package:somics_os/routes/pages.dart';
import 'package:somics_os/utils/app_constants.dart';
import 'package:somics_os/utils/dialog_utils.dart';
...
class IBaseRepository {
  ...
  Future<void> _logout() async {
    ...
    if (savedLanguage?.isNotEmpty == true) {
